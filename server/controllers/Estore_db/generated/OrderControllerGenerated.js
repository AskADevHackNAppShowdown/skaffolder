...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.get(baseUrl + "/findBy_coupon/:key", authorize([]), generatedControllers.findBy_coupon);
    router.get(baseUrl + "/findBy_products/:key", authorize([]), generatedControllers.findBy_products);
