...
const generatedControllers = {
   ...
   */
  init: router => {
    const baseUrl = `${Properties.api}/coupon`;
  ...
  */
  delete: async (req, res) => {
    try {
      const result = await CouponModel.delete(req.params.id);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  get: async (req, res) => {
    try {
      const result = await CouponModel.get(req.params.id);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  update: async (req, res) => {
    try {
      const result = await CouponModel.update(req.body);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
